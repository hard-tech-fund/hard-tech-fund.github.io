...
<html lang="en">
	<head>
		...
		<meta name="author" content="Samarth Sandeep">
		<meta name="description" content="The Hard Tech Fund is UC Davis' first sustainable hardware startup incubator.">
		...
		<main class="wrapper">
			...
			<nav class="navigation">
				<section class="container">
					<a class="navigation-title" href="https://hardtechfund.github.io/">
						...
						&nbsp;
						<h1 class="title">The Hard Tech Fund</h1>
					</a>
			...
			<h5 class="title"><strong>Who are we?</strong></h5>
			<p>The Hard Tech Fund is a startup development program founded by <a href="https://www.davishyperloop.com/Hyperloop"> Hyperloop at UC Davis </a>, <a href="https://www.ucdspacesatellitesystems.com/"> Space and Satellite Club </a>, <a href="www.blockchainatdavis.com/"> Blockchain at Davis </a>, <a href="https://bigucd.com/">Bioinnovation Group at UC Davis</a>, and <a href="https://www.facebook.com/Quantum-Computing-at-UC-Davis-329159964525722/">Quantum Computing at UC Davis</a>. All of these clubs have built or assisted in the construction of hardware that will help decrease emissions, reconstruct supply chains, and change the public perspective on environmental conservation. They wanted a dedicated space for their members and the UC Davis community to build hardware with this mission in mind. This 10 week program during the summer session will provide the time, funding, and workshops necessary to build these projects, and prepare them for becoming companies. </p>
				<p>
					<ul>
			...
			<footer class="footer">
				<section class="container">
					<p>Built at UC Davis. Licensed under the <a target="_blank" href="https://github.com/milligram/milligram#license" title="MIT License">MIT License</a>.</p>
				</section>
			</footer>
